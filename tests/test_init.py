...
class TestTimeConversion(unittest.TestCase):
    ...
    def test_convert(self):
        self.assertEqual(self.d, onedrived.str_to_datetime(self.s))
        self.assertEqual(self.s, onedrived.datetime_to_str(self.d))
        self.assertEqual(self.t, onedrived.datetime_to_timestamp(self.d))
