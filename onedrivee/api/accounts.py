...
def get_personal_account(client, code=None, uri=None):
    ...
    :param onedrivee.api.clients.PersonalClient client: The underlying client object.
...
def get_business_account(client):
    ...
    :param onedrivee.api.clients.BusinessClient client: The underlying OneDrive for Business client.
...
class PersonalAccount:
    ...
    def __init__(self, client, session_info, expires_at=None):
        ...
        :param onedrivee.api.clients.PersonalClient | onedrivee.api.clients.BusinessClient client: Parent client.
    ...
    def profile(self, value):
        """
        :param onedrivee.api.resources.UserProfile value: Profile of the account from cache.
        """
        self._profile = value
    ...
    def get_profile(self, account_id='me'):
        ...
        :return onedrivee.resources.UserProfile: Profile of the target user.
        """
    ...
    def load(cls, client, s):
        ...
        :return onedrivee.api.accounts.PersonalAccount: A deserialized account object.
        """
        data = json.loads(s)
