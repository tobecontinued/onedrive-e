...
class ItemCollection:
    ...
    def get_next(self):
        """
        :return [onedrived.api.items.OneDriveItem]: Assuming there is at least one more set, return a list of
        OneDriveItems.
        """
...
class OneDriveItem:
    ...
    def parent_reference(self):
        """
        :rtype: onedrived.api.resources.ItemReference
        """
    ...
    def folder_props(self):
        """
        :rtype: onedrived.api.facets.FolderFacet
        """
    ...
    def file_props(self):
        """
        :rtype: onedrived.api.facets.FileFacet
        """
    ...
    def image_props(self):
        """
        :rtype: onedrived.api.facets.ImageFacet
        """
    ...
    def photo_props(self):
        """
        :rtype: onedrived.api.facets.PhotoFacet
        """
    ...
    def audio_props(self):
        """
        :rtype: onedrived.api.facets.AudioFacet
        """
    ...
    def video_props(self):
        """
        :rtype: onedrived.api.facets.VideoFacet
        """
    ...
    def location_props(self):
        """
        :rtype: onedrived.api.facets.LocationFacet
        """
    ...
    def deleted_props(self):
        """
        :rtype: onedrived.api.facets.DeletedFacet
        """
