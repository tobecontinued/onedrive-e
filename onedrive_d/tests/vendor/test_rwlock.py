"""
Unit test for read-write lock based on the following article:
...
from onedrive_d.vendor.rwlock import RWLock
...
class TestRWLock(unittest.TestCase):
    def test_readers_nonexclusive_access(self):
        ...
        self.assertLessEqual(threads[1].exit_time, threads[2].entry_time)
        self.assertLessEqual(threads[2].entry_time, threads[3].entry_time)
        self.assertLess(threads[3].exit_time, threads[2].exit_time)
    ...
    def test_writers_exclusive_access(self):
        ...
        self.assertLessEqual(threads[0].exit_time, threads[1].entry_time)
        self.assertLessEqual(threads[1].exit_time, threads[2].exit_time)
    ...
    def test_writer_priority(self):
        ...
        self.assertLess(threads[0].exit_time, threads[1].entry_time)
        self.assertLessEqual(threads[1].exit_time, threads[2].entry_time)
        self.assertLessEqual(threads[2].exit_time, threads[3].entry_time)
        self.assertLessEqual(threads[2].exit_time, threads[4].entry_time)
    ...
    def test_many_writers_priority(self):
        ...
        self.assertLess(threads[0].exit_time, threads[1].entry_time)
        self.assertLessEqual(threads[1].exit_time, threads[2].entry_time)
        self.assertLessEqual(threads[1].exit_time, threads[5].entry_time)
        self.assertLessEqual(threads[2].exit_time, threads[3].entry_time)
        self.assertLessEqual(threads[2].exit_time, threads[4].entry_time)
        self.assertLessEqual(threads[5].exit_time, threads[3].entry_time)
        self.assertLessEqual(threads[5].exit_time, threads[4].entry_time)
